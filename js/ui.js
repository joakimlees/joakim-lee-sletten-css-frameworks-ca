...
const makeAccountBtn = document.getElementById("make-account-btn");
...
<div class="mt-5">
  ...
  <input type="text" class="form-control" id="username-login" aria-describedby="username" required />
</div>
<div class="mt-2">
...
<div class="d-grid mx-auto">
  <button type="submit" class="btn btn-primary">Create Account and login</button>
</div>
